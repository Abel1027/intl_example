...
class IntlStrings {
  ...
  /// `{count, plural, zero{Our counter is zero} one{The counter value is 1} other{You have pushed the button this many times: {count}}}`
  String counterTitle(num count) {
    return Intl.plural(
      count,
      zero: 'Our counter is zero',
      one: 'The counter value is 1',
      other: 'You have pushed the button this many times: $count',
      name: 'counterTitle',
      desc: '',
      args: [count],
    );
